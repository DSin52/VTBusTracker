...
@TargetApi(12)
public class StopCodeActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent newIntent = new Intent(v.getContext(), TimeCodeActivity.class);
		Bundle data = new Bundle();
		data.putString("stopNum", stringList[2].get(position));
		data.putString("stopName", stringList[1].get(position));
		data.putString("current", getCurrentBus());
		System.out.println(data.getString("stopNum"));
		newRun.cancel(true);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			setListAdapter(new ArrayAdapter<String>(StopCodeActivity.this,
